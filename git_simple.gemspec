...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Simple git command layer in Ruby.}
  spec.description   = %q{Git porcelain layer in Ruby which provides common commands for working with bare and working repositories.}
